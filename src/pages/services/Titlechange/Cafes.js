    ...
    <>
      <section className='Secrvicesection'>
        <div className='services'>
          <h2 className='serviceHeading' data-aos="fade-down">The Greenstraw Spaces</h2>
          <p className='servicePera' data-aos="fade-up">
        ...
        <div className='Bestservices'>
          <div className='bestserviceinfo container'>
            <div className='row'>
              <div className='col-lg-8 looking' data-aos="fade-right">
              ...
              <div className='col-lg-4 BS ' data-aos="fade-left">
                <button className='contactusbtn'><NavLink to='/contactus' className='moveContact' onClick={handleClick}>CONTACT US</NavLink></button>
              </div>
            </div>
          </div>
        </div>
